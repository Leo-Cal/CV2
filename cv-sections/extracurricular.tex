...
\cventry
{Diretor de Rugby} % Affiliation/role
{Associação Atlética Acadêmica Politécnica} % Organization/group
...
\begin{cvitems}
  ...
  %\item {Captação de novos atletas e administração de atuais atletas}
\end{cvitems}
\vspace{5mm}
}
