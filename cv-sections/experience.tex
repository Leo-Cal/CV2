...
\cventry
{Iniciação Científica - Modelagem de sistemas de planejamento usando inteligência artificial} % Job title
{D-Lab System Design Lab - Universidade de São Paulo } % Organization
{São Paulo-Brasil} % Location
{Out. 2016 -  Jan. 2018} % Date(s)
