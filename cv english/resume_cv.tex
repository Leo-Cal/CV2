...
\address{Avenida Corifeu de Azevedo Marques 4788, Apt 114 - Sao Paulo, SP - Brazil}
\mobile{+55 21 99259-6924}
...
\position{Undergraduate Engineer USP{\enskip\cdotp\enskip}Polytechnic School} % Your expertise/fields
%\quote{``Make the change that you want to see in the world."} % A quote or statement

\makecvfooter{\today}{Leonardo Calasans~~~·~~~Curriculum}{\thepage} % Specify the letter footer with 3 arguments: (<left>, <center>, <right>), leave any of these blank if they are not needed
